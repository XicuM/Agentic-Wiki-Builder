...
4. **Indices & Clean**: Update target `_index.md` files (ensure links have one-line summaries and do not contain checkmarks). Remove the ingested item from `state.json`.
